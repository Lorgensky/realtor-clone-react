        ...
        <div className='w-full md:w-[67%] lg:w-[40%] lg:ml-20'>
          <form>
            ...
            <div className='relative mb-6'>
              ...
              {showPassword ? <IoIosEyeOff className='absolute right-3 top-3 text-xl cursor-pointer' onClick={()=>setShowPassword((prevState)=>!prevState)}/> : <IoIosEye className='absolute right-3 top-3 text-xl cursor-pointer' onClick={()=>setShowPassword((prevState)=>!prevState)} />}
            </div>
